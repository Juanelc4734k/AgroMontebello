  ...
  return (
    <Card className="bg-white border border-gray-200">
      ...
      <CardContent className="p-3 sm:p-4">
        {/* Acciones principales - Responsive grid */}
              ...
              >
                <div className="flex items-center w-full">
                  ...
                  <div className="text-left flex-1 min-w-0">
                    {/* Título completo en pantallas grandes, corto en móviles */}
            ...
            {secondaryActions.map((action, index) => {
              ...
              return (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-full justify-start h-8 sm:h-9 text-xs sm:text-sm hover:bg-gray-50 border-gray-200"
                >
